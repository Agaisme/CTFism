<?php
	...
	define('PATH', 'http://ctf.idhak.club/'); // isi path dari website anda
	...
	define('DB_PASSWORD', 'idhak007'); // password host
	define('DB_NAME', 'idhak_ctfplat1337'); // database yang di gunakan
?>
