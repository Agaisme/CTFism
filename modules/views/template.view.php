...
<body class="site">
  ...
  <?php if($page=="user" || $page=="scoreboard" || $page=="statistics") echo '<script src="https://cdn.datatables.net/1.10.16/js/jquery.dataTables.min.js" type="text/javascript"></script>
  ...
  ';?>
    <script type="text/javascript">
      ...
      //Check if on challanges page
      <?php if($page=="challenges"){?>

        //input flag must be valid
        $('#input-keys')
          .form({
            fields: {
              keys: {
